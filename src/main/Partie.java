...
public class Partie {
     ...
     *
     * @param chemin Chemin du fichier BDCFF.
     */
     ...
     *
     * @param cheminFichierBDCFF Chemin du fichier BDCFF.
     * @param niveau Niveau choisi.
     * @param parcours Parcours à executer.
     */
     ...
     *
     * @param strategie L'ia voulue.
     * @param cheminFichierBDCFF Le chemin du fichier BDCFF contenant le niveau.
     * @param niveau Le niveau voulu.
     *
     * @return Le score obtenu.
     */
    public static Score calculerStrategie(String strategie, String cheminFichierBDCFF, int niveau) {
        ...
        if (!(Partie.ia instanceof IaRandom)) { SousMenu.finIA(score); }
        return score;
