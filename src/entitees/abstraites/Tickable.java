...
public abstract class Tickable extends Entitee implements Comparable<Tickable> {
	 ...
	 * 
	 * @param entitee
	 *            L'entitée avec laquelle se produit le contact.
	 ...
	 * 
	 * @param popDiamants
	 *            Si vrai : apparition de diamant au lieu d'explosions.
	 */
	 ...
	 * 
	 * @param i
	 *            Coordonnée en x de l'objet.
	 * @param j
	 *            Coordonnée en y de l'objet.
	 * @param popDiamants
	 *            Si vrai : apparition d'un diamant au lie ud'une explosion.
	 */
