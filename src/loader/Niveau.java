...
public class Niveau implements Cloneable {
     ...
     *
     * @param map Tableau à deux dimensions d'entitées servant à représenter la
     ...
     * dans ce niveau.
     * @param magic_wall_time Tableau à deux dimensions d'entitées servant à représenter la
     ...
     * @param enumeration Enumération du type de l'objet que l'on veut tester.
     *
     ...
     * Un setter.
     *
     * @param cave_time L'objet en question.
     */
