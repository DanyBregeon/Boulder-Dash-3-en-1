...
public class Loader {
     ...
     * carte du niveau.
     *
     * @param car Le caractère représentant l'entitée.
     * @param x La coordonnée en x de l'entitée.
     * @param y La coordonnée en y de l'entitée.
     * @param magicWallTime Le nombre d'utilisations limites de l'entitée si celle si est
     * un mur magique.
     *
     ...
     * @param string1 Le délimiteur 1.
     * @param string2 Le délimiteur 2.
     *
     * @return Le résultat.
     */
    ...
    /**
     * Prend un string en paramètre et renvoit un sous-string se trouvant dans
     * le premier string qui est délimité par le deuxième string en paramétre.
     *
     * @param texte Le string source.
     * @param string1 Le délimiteur.
     *
     * @return Le résultat.
     */
