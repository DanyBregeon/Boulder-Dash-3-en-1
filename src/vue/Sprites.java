...
public class Sprites {
	 ...
	 * 
	 * Elle appelle deux autres méthodes qui vont d�signer quels sprites
	 * afficher.
	 * 
	 * @param compteurFPS
	 *            Le compteur de FPS.
	 ...
	 * 
	 * C'est ce sprite la qui sera affiché pour représenter l'entitée.
	 * 
	 * @param compteurFPS
	 *            Le compteur de FPS.
	 */
	 ...
	 * les sprites.
	 * 
	 * Elle prend en paramètre le dossier ou se trouvent les images et lis
	...
	/**
	 * Cette méthode regarde dans {@link Sprites#CHARGEMENT_SPRITES} et dispose
	 * le sprite de la poussi�re dans la liste apropriée.
	 */
